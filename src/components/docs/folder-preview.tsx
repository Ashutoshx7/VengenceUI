...
export function FolderPreviewDemo() {
    return (
        <div className="grid grid-cols-3 gap-8 p-8 bg-neutral-50 dark:bg-black rounded-xl border border-neutral-200 dark:border-[#222]">
...
export function FolderPreviewSingle() {
    return (
        <div className="flex items-center justify-center min-h-[350px] bg-neutral-50 dark:bg-black rounded-xl p-16 overflow-visible border border-neutral-200 dark:border-[#222]">
            <FolderPreview
                variant="devi"
                label="Shared Files"
                size="lg"
...
export function FolderPreviewCustom() {
    return (
        <div className="flex items-center justify-center gap-16 min-h-[300px] bg-neutral-50 dark:bg-black rounded-xl p-12 border border-neutral-200 dark:border-[#222]">
            <FolderPreview
                variant="ardra"
                label="Photos"
                size="lg"
...
export function FolderPreviewFiles() {
    return (
        <div className="flex items-center justify-center gap-16 min-h-[350px] bg-neutral-50 dark:bg-black rounded-xl p-12 border border-neutral-200 dark:border-[#222]">
            <FolderPreview
                variant="durga"
                label="Project"
                size="lg"
...
export function FolderPreviewSizes() {
    return (
        <div className="flex items-end justify-center gap-12 min-h-[300px] bg-neutral-50 dark:bg-black rounded-xl p-12 border border-neutral-200 dark:border-[#222]">
