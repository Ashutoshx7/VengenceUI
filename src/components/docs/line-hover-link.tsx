...
export function LineHoverLinkDemo() {
    return (
        <div className="flex flex-col items-center justify-center w-full h-full gap-8 p-12 bg-neutral-50 dark:bg-black rounded-xl min-h-[350px] border border-neutral-200 dark:border-[#222] shadow-sm">
...
export function LineHoverLinkSingle() {
    return (
        <div className="flex items-center justify-center gap-8 p-12 bg-white dark:bg-black rounded-xl min-h-[200px] border border-neutral-200 dark:border-[#222]">
            <LineHoverLink
                variant="slide"
                href="#"
...
export function LineHoverLinkNavigation() {
    return (
        <div className="flex items-center justify-center p-12 bg-white dark:bg-black rounded-xl min-h-[200px] border border-neutral-200 dark:border-[#222]">
...
export function LineHoverLinkSVG() {
    return (
        <div className="flex items-center justify-center gap-12 p-12 bg-white dark:bg-black rounded-xl min-h-[200px] border border-neutral-200 dark:border-[#222]">
            <LineHoverLink
                variant="arc"
                href="#"
