...
export function LogoSliderDemo() {
    return (
        <div className="w-full h-full flex flex-col justify-center py-12 bg-neutral-50 dark:bg-black rounded-xl min-h-[200px] border border-neutral-200 dark:border-[#222]">
...
export function LogoSliderRight() {
    return (
        <div className="w-full py-12 bg-neutral-50 dark:bg-black rounded-xl min-h-[200px] border border-neutral-200 dark:border-[#222]">
...
export function LogoSliderDouble() {
    return (
        <div className="w-full py-8 bg-neutral-50 dark:bg-black rounded-xl space-y-4 min-h-[280px] border border-neutral-200 dark:border-[#222]">
