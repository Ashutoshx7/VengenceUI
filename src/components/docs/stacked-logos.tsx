...
export function StackedLogosDemo() {
  return (
    <div className="w-full h-full flex items-center justify-center py-16 bg-neutral-50 dark:bg-black rounded-xl min-h-[250px] border border-neutral-200 dark:border-[#222]">
      <StackedLogos
...
export function StackedLogosFast() {
  return (
    <div className="w-full py-16 bg-neutral-50 dark:bg-black rounded-xl min-h-[250px] flex items-center justify-center border border-neutral-200 dark:border-[#222]">
      <StackedLogos
        logoGroups={[logoGroup1, logoGroup2, logoGroup3, logoGroup4]}
        duration={10}
        stagger={1}
...
export function StackedLogosSlow() {
  return (
    <div className="w-full py-16 bg-neutral-50 dark:bg-black rounded-xl min-h-[280px] flex items-center justify-center border border-neutral-200 dark:border-[#222]">
      <StackedLogos
        logoGroups={[logoGroup1, logoGroup2, logoGroup3, logoGroup4]}
        duration={40}
        stagger={3}
