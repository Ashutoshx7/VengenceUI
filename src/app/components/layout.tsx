...
export default function ComponentsLayout({
  ...
  return (
    <div className="w-full px-4 md:px-8 flex-1 items-start md:grid md:grid-cols-[220px_16px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_16px_minmax(0,1fr)] lg:gap-8 xl:grid-cols-[240px_16px_minmax(0,1fr)_200px]">
